...
public class OozeBattleState : EnemyState
{
    private Enemy_Ooze enemy;
    private Transform player;
    private int moveDir;

    public OozeBattleState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, Enemy_Ooze _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        this.enemy = _enemy;
    }
