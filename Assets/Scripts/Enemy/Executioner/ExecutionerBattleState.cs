...
public class ExecutionerBattleState : EnemyState
{
    private Transform player;
    private Enemy_Executioner enemy;
    private int moveDir;

    public ExecutionerBattleState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, Enemy_Executioner _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        this.enemy = _enemy;
    }
